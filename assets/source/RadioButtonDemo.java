...
/**
 * A small program that demonstrates JRadioButton with a group
 * of radio buttons that control the background color of a label.
 * This class includes a main() routine so it can be run as an
...
public class RadioButtonDemo extends JPanel implements ActionListener {
   ...
   /**
    * Respond when the user clicks one of the radio buttons by
    * changing the text and background color of the label.
    */
